...
export default function SearchBar({
    ...
    return (
        <div
            className={`${searchBarContainerDesign} ${isFocused ? 'rounded-t-[5px]' : 'rounded-[5px]'}`}
        >
            ...
            {isFocused && filteredSearches.length > 0 && !disable && (
                ...
                <div className={`absolute top-full overflow-y-auto left-0 w-full bg-white shadow-lg rounded-b-[5px] border border-gray-200 z-50 no-scrollbar ${searchResultHeight}`}>
                    <ul className="py-1">
