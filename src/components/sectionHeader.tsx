...
export default function SectionHeader({
  headerBarContainerDesign = "flex mt-5 flex-row rounded-2xl items-center gap-2 md:gap-4 w-full max-w-[55vw] bg-white border-b border-gray-200 px-3 md:px-6 py-3 md:py-4 shadow-sm min-w-[250px] mx-4",
  profileLink,
