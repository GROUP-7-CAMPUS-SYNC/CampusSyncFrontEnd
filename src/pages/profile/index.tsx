...
export default function ProfilePage() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto pb-10 py-6">
      {/* 1. PROFILE HEADER */}
      <div className="bg-white shadow-sm sm:rounded-2xl overflow-hidden mb-8 border border-gray-200">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 mt-1 text-gray-600 text-sm">
                <div className="flex items-center gap-2">
                  {" "}
                  <Briefcase size={14} /> <span>Student / User</span>{" "}
                </div>
                <div className="flex items-center gap-2">
                  {" "}
                  <GraduationCap size={14} /> <span>University Student</span>{" "}
                </div>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-6 w-full">
        <div className="w-full mx-auto">
          <h2 className="text-xl font-bold text-gray-800 mb-4 ml-2 sm:ml-0">
            My Posts
          </h2>
          {loading ? (
